...
Aroma Module that (hopefully) exports all functions of libcurl (Currently targeting: curl 8.7.1)
...
The bundled Dockerfile creates a module with this version: `libcurl/8.7.1 mbedTLS/2.28.8 zlib/1.3.1 brotli/1.2.0`
